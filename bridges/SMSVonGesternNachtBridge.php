...
class SMSVonGesternNachtBridge extends BridgeAbstract {
  ...
  public function loadMetadatas() {
		...
		$this->uri = "http://www.chatvongesternnacht.de/";
		$this->description = "The Unofficial SMSVonGesternNacht Bridge";
		$this->update = "2016-02-13";
	}

  public function collectData(array $param) {
    $html = file_get_html('http://www.chatvongesternnacht.de/') or $this->returnError('Could not request SMSVonGesternNacht.', 404);
